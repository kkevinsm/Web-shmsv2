        ...
        <div class="col-12 col-lg-9"> 
                        ...
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    ...
                                    <h6 class="font-extrabold mb-0">x y z</h6>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- <div class="card">
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card-gedung-1 mt-auto">
                            <img src="{{ asset ('dist/assets/compiled/svg/gedung-1.svg') }}" alt="gedung-1">
                    </div>
                </div>
            </div>  -->
            <!-- <div class="row">
            ...
            <div class="card">
                <div class="card-body py-4 px-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3 name">
                            <h5 class="font-bold">kkevinsm</h5>
                            <h6 class="text-muted mb-0">@kkevinsm</h6>
                        </div>
                    </div>
                </div>
            </div>
